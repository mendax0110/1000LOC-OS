...
#define PROCS_MAX 8     // macx number of processes

#define PROC_UNUSED   0 // unused process slot 
#define PROC_RUNNABLE 1 // runnable process slot
...
struct process
{
    ...
    int state; // possible states e.g PROC_UNUSED, PROC_RUNNABLE, PROC_EXITED
